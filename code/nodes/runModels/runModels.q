...
runModels.node.outputs :`bestModel`modelMetaData`bestScoringName`modelMetaData!"<!s!"
runModels.node.function:{[cfg;tts;mdls]
  `bestModel`modelMetaData`bestScoringName`modelMetaData!(`embedpymdl;()!();`RandomForestRegressor;()!())
  }
